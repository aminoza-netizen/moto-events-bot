  ...
  "events": [
    {
      ...
      "announce_ru": "пост для Telegram на русском, 300–600 символов: эмодзи + <b>заголовок</b>, пустая строка, 1–2 коротких абзаца (дата по-русски, город, что будет), предпоследняя строка «📍 <b>Локация:</b> ...», последняя — <a href=\\"url\\">Подробнее</a>. Только теги <b> <i> <a>."
    }
  ]
}
