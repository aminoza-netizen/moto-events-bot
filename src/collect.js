...
- НЕ дословный перевод. Перескажи своими словами: просто, коротко, по делу — как пишет живой админ канала для своих.
- Структура: эмодзи + цепляющий заголовок жирным → пустая строка → 2–3 коротких абзаца или строки-пункты → пустая строка → ссылка на источник.
- Для события обязательно: дата по-русски (напр. «15 августа»), город, что будет, для кого интересно.
- Для события предпоследней строкой (перед ссылкой): «📍 <b>Локация:</b> место/адрес, город» — конкретная площадка или адрес, если известны, иначе хотя бы город.
- Для новости обязательно: что изменилось и ЧТО ЭТО ЗНАЧИТ для мотоциклиста в Испании (штраф, срок, обязанность) — цифры и даты сохраняй точно. Если известна дата вступления в силу — укажи её явно («с 1 октября 2026»); не подавай будущие изменения как уже действующие.
- Живой тон, 2–4 эмодзи. СТРОГО не длиннее 900 символов.
...
- Последняя строка: <a href="...">Подробнее</a> (или название источника).
